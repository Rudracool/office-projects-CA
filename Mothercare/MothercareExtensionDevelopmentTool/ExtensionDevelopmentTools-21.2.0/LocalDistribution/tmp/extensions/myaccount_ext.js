...
extensions['ReorderExtensionListHeader.ReOrderItemExtPdfAndCsv.1.0.0'] = function(){

function getExtensionAssetsPath(asset){
	return 'extensions/ReorderExtensionListHeader/ReOrderItemExtPdfAndCsv/1.0.0/' + asset;
}
...
extensions['Example.SCCCTEncourage.1.0.0'] = function(){

function getExtensionAssetsPath(asset){
	return 'extensions/Example/SCCCTEncourage/1.0.0/' + asset;
}
...
extensions['CA.SlideShowPro.1.0.0'] = function(){

function getExtensionAssetsPath(asset){
	return 'extensions/CA/SlideShowPro/1.0.0/' + asset;
}
...
SC.ENVIRONMENT.EXTENSIONS_JS_MODULE_NAMES = ["Acme.ImagesGridSlideShow.ImagesGridSlideShow.View","Acme.ImagesGridSlideShow.ImagesGridSlideShow.Model","Acme.ImagesGridSlideShow.ImagesGridSlideShow.SS2Model","jquery.slick","ReorderExtensionListHeader.ReOrderItemExtPdfAndCsv.ReorderExtensionsListHeaderPdf.View","ReorderExtensionListHeader.ReOrderItemExtPdfAndCsv.ReorderExtensionsListHeaderPdf.Model","ReorderExtensionListHeader.ReOrderItemExtPdfAndCsv.ReorderExtensionsListHeaderPdf.SS2Model","","Example.SCCCTEncourage.Encourage.View","Example.SCCCTEncourage.Encourage.Model","Example.SCCCTEncourage.Encourage.SS2Model","jquery.slick","Cloudalp.SlideShowPro.SlideShowModule.View"];
try{
...
try{
	extensions['ReorderExtensionListHeader.ReOrderItemExtPdfAndCsv.1.0.0']();
	SC.addExtensionModule('ReorderExtensionListHeader.ReOrderItemExtPdfAndCsv.ReorderExtensionsListHeaderPdf');
}
catch(error)
{
	console.error(error);
...
try{
	extensions['Example.SCCCTEncourage.1.0.0']();
...
try{
	extensions['CA.SlideShowPro.1.0.0']();
	SC.addExtensionModule('Cloudalp.SlideShowPro.SlideShowModule');
}
catch(error)
{
	console.error(error);
