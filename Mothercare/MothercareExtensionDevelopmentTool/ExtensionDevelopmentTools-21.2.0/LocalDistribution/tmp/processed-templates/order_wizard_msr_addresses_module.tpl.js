define('order_wizard_msr_addresses_module.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var t = {"1":function(container,depth0,helpers,partials,data) {
  ...
  return "				<p class=\"order-wizard-msr-addresses-module-new-address-title\">"
    ...
    + ((stack1 = compilerNameLookup(helpers,"if").call(alias1,(depth0 != null ? compilerNameLookup(depth0,"showSaveButton") : depth0),{"name":"if","hash":{},"fn":container.program(10, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":24,"column":4},"end":{"line":30,"column":10}}})) != null ? stack1 : "")
    + "		</div>\r\n";
  ...
  return "	<p class=\"order-wizard-msr-addresses-module-new-address-title\">"
    ...
    + " class=\"order-wizard-msr-addresses-module-form-placeholder\">\r\n\r\n		<div data-view=\"New.Address.Form\"></div>\r\n\r\n"
    + ((stack1 = compilerNameLookup(helpers,"if").call(alias1,(depth0 != null ? compilerNameLookup(depth0,"showSaveButton") : depth0),{"name":"if","hash":{},"fn":container.program(13, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":40,"column":2},"end":{"line":46,"column":9}}})) != null ? stack1 : "")
    + "	</div>\r\n";
