define('product_views_option_facets_color.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var t = {"1":function(container,depth0,helpers,partials,data) {
  ...
  return "					<div class=\"product-views-option-facets-color-picker-small\">\r\n						<label class=\"product-views-option-facets-color-picker-label\">\r\n								<a class=\"product-views-option-facets-color-picker-anchor\" >\r\n"
    + ((stack1 = compilerNameLookup(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? compilerNameLookup(depth0,"isColorTile") : depth0),{"name":"if","hash":{},"fn":container.program(8, data, 0, blockParams, depths),"inverse":container.program(11, data, 0, blockParams, depths),"data":data,"loc":{"start":{"line":20,"column":9},"end":{"line":29,"column":16}}})) != null ? stack1 : "")
    + "								</a>\r\n						</label>\r\n					</div>\r\n";
  ...
  return "										<span data-label=\"label-"
    ...
    + "\" data-action=\"changethumbnail\" value=\""
    ...
    + ((stack1 = compilerNameLookup(helpers,"if").call(alias3,(depth0 != null ? compilerNameLookup(depth0,"isLightColor") : depth0),{"name":"if","hash":{},"fn":container.program(9, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":21,"column":160},"end":{"line":21,"column":244}}})) != null ? stack1 : "")
    + "\"\r\n										style=\"cursor:pointer;background: "
    + alias2(((helper = (helper = compilerNameLookup(helpers,"color") || (depth0 != null ? compilerNameLookup(depth0,"color") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(alias3,{"name":"color","hash":{},"data":data,"loc":{"start":{"line":22,"column":44},"end":{"line":22,"column":53}}}) : helper)))
    + "\"></span>\r\n";
