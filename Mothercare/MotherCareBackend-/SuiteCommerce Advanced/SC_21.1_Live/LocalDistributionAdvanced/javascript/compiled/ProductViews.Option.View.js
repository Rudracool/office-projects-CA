...
*/
define("ProductViews.Option.View", ["require", "exports", "underscore", "Configuration", "Backbone.View", "bootstrap-datepicker"], function (require, exports, _, Configuration_1, BackboneView) {
    "use strict";
    ...
    var ProductViewsOptionView = BackboneView.extend({
        ...
        initialize: function () {
            ...
            if (item_options_default_templates && item_options_default_templates.selectorByType) {
                ...
                if (!this.config.templates.selected) {
                    ...
                    var default_option_selected_template = item_options_default_templates.selectedByType.default;
                ...
                if (!this.config.templates.facetCell) {
                    ...
                    var default_option_facetcell_template = item_options_default_templates.facetCellByType.default;
    ...
    return ProductViewsOptionView;
});

//# sourceMappingURL=ProductViews.Option.View.js.map
