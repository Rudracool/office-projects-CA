...
/// <amd-module name="DownloadItems.Collection"/>

import * as _ from 'underscore';
import * as Utils from '../../../Commons/Utilities/JavaScript/Utils';

import { DownloadItemsModel } from './DownloadItems.Model';
import Backbone = require('../../../Commons/Utilities/JavaScript/backbone.custom');

// @class Quote.Collection @extends Backbone.Collection
const DownloadItemsCollection: any = Backbone.Collection.extend({
    // @property {Quote.Model} model
    model: DownloadItemsModel,

    // @property {String} url
    url: 'services/DownloadItems.Service.ss?types=Estimate',
...
export = DownloadItemsCollection;
