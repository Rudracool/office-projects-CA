...
define('DownloadItems.Model', [
    ...
    let DownloadItemsToSalesOrderValidatorModel;

    try {
        DownloadItemsToSalesOrderValidatorModel = require('DownloadItemsToSalesOrderValidator.Model');
    } catch (e) {}
    ...
    return TransactionModel.extend({
        ...
        getTransactionRecord: function() {
            ...
            const days_to_expire = Configuration.get('DownloadItems.daysToExpire');
            if (days_to_expire !== 0) {
        ...
        getExtraRecordFields: function() {
            ...
            if (!this._isCreatingARecord()) {
                ...
                this.getSalesRep();
                this.result.purchasablestatus = DownloadItemsToSalesOrderValidatorModel
                    ? DownloadItemsToSalesOrderValidatorModel.getDownloadItemsToSalesOrderValidation(this.result)
                    : {};
            } else {
        ...
        // @return
        _getDownloadItemsStatus: function(estimate_id) {
        ...
        getEntityStatus: function() {
            ...
            const estimate_aux = this._getDownloadItemsStatus(this.record.getId());
