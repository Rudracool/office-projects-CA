...
export = BackboneView.extend({
    ...
    getContext: function() {
        ...
        return {
            ...
            headerLinkHref: this.options.headerLinkHref || 'https://www.forneycorp.com/',
            // @property {String} headerLinkTouchPoint
            headerLinkTouchPoint: this.options.headerLinkTouchPoint || 'https://www.forneycorp.com/',
            // @property {String} headerLinkHashtag
            headerLinkHashtag: this.options.headerLinkHashtag || 'https://www.forneycorp.com/',
