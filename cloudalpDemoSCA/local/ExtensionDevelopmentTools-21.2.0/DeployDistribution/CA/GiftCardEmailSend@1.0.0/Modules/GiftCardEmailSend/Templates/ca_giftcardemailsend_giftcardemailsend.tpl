...
<div id="gift-certificate-container" class="gift-certificate-container">
  <div class="main-data-container">
    ...
    <textarea name="custbody_custom_gift_certificate_mess" placeholder="Enter Your Gift certificate comments" id="cust_data_msg" cols="30" rows="1">{{#if isReview}}{{model.options.custbody_custom_gift_certificate_mess}}{{/if}}</textarea>
    </div>
...
<div class="emailTemplateMailData ">
  <div class="emailform">
    <div data-type="semailMessage"></div>
    ...
    <div class="buttonSendEmail">
        <button data-action="sendEmailToReceipant" class="email-btn" >{{translate 'Send Email'}}</button>
    </div>
  </div>
</div>
