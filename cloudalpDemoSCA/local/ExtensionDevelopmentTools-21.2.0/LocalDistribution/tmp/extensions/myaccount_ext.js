...
extensions['CA.stockDetailsInPurchaseHistory.1.0.0'] = function(){

function getExtensionAssetsPath(asset){
	return 'extensions/CA/stockDetailsInPurchaseHistory/1.0.0/' + asset;
}
...
// -----------------------
// @module Case
define("CA.stockDetailsInPurchaseHistory.stockDetailsInPurchaseHistory.Model", ["Backbone", "Utils"], function(
    Backbone,
    Utils
) {
    "use strict";
    ...
    return Backbone.Model.extend({
        ...
        urlRoot: Utils.getAbsoluteUrl(
            getExtensionAssetsPath(
                "services/stockDetailsInPurchaseHistory.Service.ss"
            )
        )
...
SC.ENVIRONMENT.EXTENSIONS_JS_MODULE_NAMES = ["mia.instafeed.instafeedExt.View","mia.instafeed.instafeedExt.Model","mia.instafeed.instafeedExt.SS2Model","Instafeed","jquery.slick","CA.OfferModalPopupAfterLogin.OfferModalPopupAfterLogin.View","CA.OfferModalPopupAfterLogin.OfferModalPopupAfterLogin.Model","CA.OfferModalPopupAfterLogin.OfferModalPopupAfterLogin.SS2Model","CA.stockDetailsInPurchaseHistory.stockDetailsInPurchaseHistory.View","CA.stockDetailsInPurchaseHistory.stockDetailsInPurchaseHistory.Model","CA.stockDetailsInPurchaseHistory.stockDetailsInPurchaseHistory.SS2Model"];
try{
...
try{
	extensions['CA.stockDetailsInPurchaseHistory.1.0.0']();
	SC.addExtensionModule('CA.stockDetailsInPurchaseHistory.stockDetailsInPurchaseHistory');
}
catch(error)
{
	console.error(error);
