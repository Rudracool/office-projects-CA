...
extensions['CA.GiftCardEmailSend.1.0.0'] = function(){

function getExtensionAssetsPath(asset){
	return 'extensions/CA/GiftCardEmailSend/1.0.0/' + asset;
}
...
// -----------------------
// @module Case
define("CA.GiftCardEmailSend.GiftCardEmailSend.Model", ["Backbone", "Utils"], function(
    Backbone,
    Utils
) {
    "use strict";
    ...
    return Backbone.Model.extend({
        ...
        urlRoot: Utils.getAbsoluteUrl(
            getExtensionAssetsPath(
                "services/GiftCardEmailSend.Service.ss"
            )
        )
...
SC.ENVIRONMENT.EXTENSIONS_JS_MODULE_NAMES = ["GiftCardEmailSend.GiftCardEmailSend.View","CA.GiftCardEmailSend.GiftCardEmailSend.Model","giftCertificateMessage.giftCertificateMessage.View","ca.giftCertificateMessage.giftCertificateMessage.Model","ca.giftCertificateMessage.giftCertificateMessage.SS2Model","CA.HideAddtoCartBtnInGiftItem.HideAddtoCartBtnInGiftItem.View","CA.HideAddtoCartBtnInGiftItem.HideAddtoCartBtnInGiftItem.Model","CA.HideAddtoCartBtnInGiftItem.HideAddtoCartBtnInGiftItem.SS2Model","mia.instafeed.instafeedExt.View","mia.instafeed.instafeedExt.Model","mia.instafeed.instafeedExt.SS2Model","Instafeed","jquery.slick","CA.OfferModalPopupAfterLogin.OfferModalPopupAfterLogin.View","CA.OfferModalPopupAfterLogin.OfferModalPopupAfterLogin.Model","CA.OfferModalPopupAfterLogin.OfferModalPopupAfterLogin.SS2Model","CA.surchargeCreditcard.surchargeCreditcard.View","CA.surchargeCreditcard.surchargeCreditcard.Model"];
try{
	extensions['CA.GiftCardEmailSend.1.0.0']();
	SC.addExtensionModule('CA.GiftCardEmailSend.GiftCardEmailSend');
}
catch(error)
{
	console.error(error);
...
try{
	...
	SC.addExtensionModule('cloudAlp.giftCertificateMessage.giftCertificateMessage');
}
catch(error)
{
	console.error(error);
