...
extensions['RFI.CustomBlogSlider.1.0.0'] = function(){

function getExtensionAssetsPath(asset){
	return 'extensions/RFI/CustomBlogSlider/1.0.0/' + asset;
}
...
// -----------------------
// @module Case
define("RFI.CustomBlogSlider.CustomBlogerSlider.SS2Model", ["Backbone", "Utils"], function(
    Backbone,
    Utils
) {
    "use strict";
    ...
    return Backbone.Model.extend({
        ...
        urlRoot: Utils.getAbsoluteUrl(
            getExtensionAssetsPath(
                "Modules/CustomBlogerSlider/SuiteScript2/CustomBlogerSlider.Service.ss"
            ),
            true
        )
});
...
extensions['CA.CustomCMSPageLayout.1.0.0'] = function(){

function getExtensionAssetsPath(asset){
	return 'extensions/CA/CustomCMSPageLayout/1.0.0/' + asset;
}
...
// -----------------------
// @module Case
define("CA.CustomCMSPageLayout.CustomCMSPageLayout.Model", ["Backbone", "Utils"], function(
    Backbone,
    Utils
) {
    "use strict";
    ...
    return Backbone.Model.extend({
        ...
        urlRoot: Utils.getAbsoluteUrl(
            getExtensionAssetsPath(
                "services/CustomCMSPageLayout.Service.ss"
            )
        )
...
extensions['CA.PdpPdf.1.0.0'] = function(){

function getExtensionAssetsPath(asset){
	return 'extensions/CA/PdpPdf/1.0.0/' + asset;
}
...
SC.ENVIRONMENT.EXTENSIONS_JS_MODULE_NAMES = ["CloudAlp.Certificates.Certificates.View","CloudAlp.Certificates.Certificates.Model","RFI.CustomBlogSlider.CustomBlogerSlider.View","RFI.CustomBlogSlider.CustomBlogerSlider.Model","RFI.CustomBlogSlider.CustomBlogerSlider.SS2Model","jquery.slick","CA.CustomCMSPageLayout.CustomCMSPageLayout.View","CA.CustomCMSPageLayout.CustomCMSPageLayout.Model","CA.CustomCMSPageLayout.CustomCMSPageLayout.SS2Model","CA.customFacetsItem.customFacetsItem.View","CA.customFacetsItem.customFacetsItem.Model","CA.customFacetsItem.customFacetsItem.SS2Model","Acme.ImagesGridSlideShow.ImagesGridSlideShow.View","Acme.ImagesGridSlideShow.ImagesGridSlideShow.Model","Acme.ImagesGridSlideShow.ImagesGridSlideShow.SS2Model","jquery.slick","mia.instafeed.instafeedExt.View","mia.instafeed.instafeedExt.Model","mia.instafeed.instafeedExt.SS2Model","Instafeed","jquery.slick","CA.PdpPdf.PDPCustompdf.View","CA.PdpPdf.PDPCustompdf.Model","CA.PdpPdf.PDPCustompdf.SS2Model","Demo.RequestShippingAddress.RequestShippingAddressModule.View","Demo.RequestShippingAddress.RequestShippingAddressModule.Model","Demo.RequestShippingAddress.RequestShippingAddressModule.SS2Model","CA.SpecialOrderItems.Specialorderitem.View","CA.SpecialOrderItems.Specialorderitem.Model","CA.SpecialOrderItems.Specialorderitem.SS2Model","CA.surchargeCreditcard.surchargeCreditcard.View","CA.surchargeCreditcard.surchargeCreditcard.Model","Uf.UserFilter.UserFilterModule.View","Uf.UserFilter.UserFilterModule.Model"];
try{
...
try{
	extensions['RFI.CustomBlogSlider.1.0.0']();
	SC.addExtensionModule('RFI.CustomBlogSlider.CustomBlogerSlider');
}
catch(error)
{
	console.error(error);
...
try{
	extensions['CA.CustomCMSPageLayout.1.0.0']();
	SC.addExtensionModule('CA.CustomCMSPageLayout.CustomCMSPageLayout');
}
catch(error)
{
	console.error(error);
...
try{
	extensions['CA.PdpPdf.1.0.0']();
	SC.addExtensionModule('CA.PdpPdf.PDPCustompdf');
}
catch(error)
{
	console.error(error);
