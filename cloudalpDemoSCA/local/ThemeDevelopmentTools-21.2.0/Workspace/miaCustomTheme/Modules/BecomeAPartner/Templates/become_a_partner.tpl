...
<div class="input-field" data-validation="control-group">
      ...
      <input class="become-a-partner-input input-area" type="text" name="prodofinterest" >
		   </div>
...
<div class="input-field" data-validation="control-group">
 <div class="lastname-field become-a-partner-input-box" data-validation="control">
    ...
    <select class="same-select-field dynamic_add"  name="distributorRelationship"  id="select-options">
...
<div class="input-field" data-validation="control-group">
	 <div class="lastname-field become-a-partner-input-box  " data-validation="control">
      ...
      <select  class="same-select-field dynamic_add"  name="brandSold"  id="select-options">
...
{{/with}} 
 ...
 {{#with listOptions}}
<div class="input-field" data-validation="control-group">
		  <div class="lastname-field become-a-partner-input-box cs_container" data-validation="control">
      <lable class="become-a-partner-lable" for="" >Customer Industry Type*</lable>
       <select  class="same-select-field dynamic_add" name="industryType" id="select-options">
      <option value="" selected>Choose Brands</option>
     	{{#each brandSold}}
						<option value="{{id}}">{{name}}</option>
		{{/each}}
