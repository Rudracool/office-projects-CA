...
define('Transaction.Model', [
    ...
    return SCModel.extend({
        ...
        loadItemsWithStoreItem: function(items_to_preload) {
            ...
            console.warn('loadItemsWithStoreItem',JSON.stringify(result));
            return result;
        },
        ...
        loadItemsWithSuiteScript: function(items_to_query) {
            ...
            if (items_to_query.length > 0) {
                ...
                const columns = [
                    ...
                    new nlobjSearchColumn('outofstockbehavior', 'item'),
                    new nlobjSearchColumn('outofstockmessage', 'item')
                ...
                _.each(inactive_items_search, function(item) {
                    loaded_item = {
                        ...
                        outofstockbehavior: item.getValue('outofstockbehavior', 'item'),
                        outofstockmessage:item.getValue('outofstockmessage','item')
                    };

                    result[item.getValue('internalid', 'item')] = loaded_item;
                });
            }
            console.warn('loadItemsWithSuiteScript',JSON.stringify(result));
            return result;
        },
