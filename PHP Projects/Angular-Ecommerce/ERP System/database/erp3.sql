...
--
-- Table structure for table `addditional table field`
--

CREATE TABLE `additional_attributes` (
  `ID` int(11) NOT NULL,
  `ATTRIBUTES_ID` varchar(50) DEFAULT NULL,
  `NAME` varchar(50) DEFAULT NULL,
  `APPLIESTO` varchar(50) DEFAULT NULL,
  `APPLIED_TABLE_ID` varchar(50) DEFAULT NULL,
  `TYPE_OF_FIELD` VARCHAR(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `file_manger` (
  `ID` int(11) NOT NULL,
  `INTERNAL_ID` varchar(50) DEFAULT NULL,
  `IMAGE_DIR` varchar(50) DEFAULT NULL,
